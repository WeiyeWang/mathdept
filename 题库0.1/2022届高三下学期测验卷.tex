...
\item 在$\Delta ABC$中, 已知$AB=1$, $BC=2$, 若$y=\begin{vmatrix}
\cos C & \sin C  \\ \sin C  & \cos C  \end{vmatrix}$, 则$y$的最小值是\blank{50}.
\item 已知双曲线$C:\dfrac{x^2}9-\dfrac{y^2}8=1$, 左、右焦点分别为$F_1$、$F_2$, 过点$F_2$作一直线与双曲线$C$的右支交于$P$、$Q$两点, 使得$\angle {F_1}PQ=90^\circ$, 则$\Delta {F_1}PQ$的内切圆的半径$r=$\blank{50}
...
%$d=|x_1-x_2|=\sqrt{|x_1-x_2|^2}=\sqrt{|(x_1-x_2)^2|}=\sqrt{|(x_1+x_2)^2-4x_1x_2|}=\sqrt{|(-\dfrac{b}{a})^2-4\dfrac{c}{a}|}$
\end{enumerate}
\end{document}