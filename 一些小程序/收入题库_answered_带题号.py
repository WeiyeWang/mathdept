...
#文件名须修改
with open(r"题库0.1\2022年秋考.tex","r",encoding = "utf8") as f:
    data = f.read()
...
for i in range(len(problems)):
    ...
    p = problems[i]
    a = answers[i]
    problems_str += (head_str + str(id).zfill(6) + body_str_1 + p + body_str_2 + a +  body_str_3 + usage + body_str_4 + origin + origin_sub + body_str_5 + editor + body_str_6)
    id += 1
